export const translations = {
  en: {
    ...
    admin: {
      ...
      loginDescription: 'Enter password to access admin panel',
      ownerAuth: 'You are authenticated as the owner',
      password: 'Password',
  ...
  es: {
    ...
    projects: {
      ...
      allTechnologies: 'Todos',
      showingResults: 'Mostrando {count} de {total} {projects}',
      project: 'proyecto',
      projects: 'proyectos',
      noResults: 'No hay proyectos que coincidan con tu búsqueda.',
    ...
    admin: {
      ...
      description: 'Agregar, editar o eliminar proyectos del portafolio',
      loginTitle: 'Acceso de Administrador',
      loginDescription: 'Ingrese la contraseña para acceder al panel de administración',
      ownerAuth: 'Estás autenticado como propietario',
      password: 'Contraseña',
      ...
      liveUrl: 'URL de Demo en Vivo',
      imageUrl: 'URL de Imagen (opcional)',
      required: 'Requerido',
      searchPlaceholder: 'Buscar proyectos por título, descripción o tecnología...',
      filterByTech: 'Filtrar por tecnología:',
      ...
      titleDescRequired: 'El título y la descripción son obligatorios',
      projectAdded: 'Proyecto agregado exitosamente',
