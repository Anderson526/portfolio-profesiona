    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="container mx-auto px-6 py-24 relative z-10">
        ...
        >
          ...
          >
            Crafting elegant digital experiences through code, design, and innovation.
            Specialized in full-stack development with a passion for cutting-edge technologies.
          </motion.p>
